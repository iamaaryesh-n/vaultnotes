...
CREATE TABLE IF NOT EXISTS "public"."books" (
    ...
    "cover_icon" "text",
    "password_hint" "text",
    "font_choice" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "encrypted_dek_with_password" "text",
    "encrypted_dek_with_recovery" "text"
);
...
CREATE POLICY "Users can read their own pages" ON "public"."pages" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own pages" ON "public"."pages" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
