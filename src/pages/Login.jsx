...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 fade-in">
      <form onSubmit={handleLogin} className="flex flex-col gap-4 w-80 bg-white p-8 rounded-xl shadow-sm border border-gray-200">
        <h1 className="text-3xl font-bold text-yellow-500 mb-2">Login</h1>
